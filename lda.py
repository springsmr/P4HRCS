...
def predict(subject, model, data_scaler, data_path, submission_path, test_labels):
...
def run_trainer():
    ...
    #这里存在问题，/mnt/sda4/CODING/python/kaggle_data/test_labels.csv 哪里获得的
